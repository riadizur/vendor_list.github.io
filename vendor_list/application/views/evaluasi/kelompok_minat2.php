				...
				<div class="portlet-body">
					<div class="portlet-body form">
						...
						<div class="row">
							<div class="col-md-4"></div>
							<div class="col-md-5">
								<label class="col-md-2 control-label align-left">Minat :</label>
								<div class="col-md-10">
									<?=$dropdown_minat;?>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="table-scrollable">
									<table class="table table-striped table-hover" id="tabel_minat" width="100%">
										<thead>
...
<script>
	...
	function load_tabel_minat(kode_minat,prov){
		var columnDef = [{
			"targets": [-1],
			"orderable": true,
		...
		load_tabel('tabel_minat',{'kode_minat':kode_minat,'prov':prov},columnDef);
	}
